...
var BoardRouter = /** @class */ (function () {
    function BoardRouter() {
        this.router = express_1.Router();
        this.routes();
    }
    BoardRouter.prototype.getAllLists = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        Lists = _a.sent();
                        return [4 /*yield*/, Card_model_1.default.find()];
                    case 2:
                        Cards = _a.sent();
                        res.json({
                            Lists: Lists,
...
var boardRoutes = new BoardRouter();
exports.default = boardRoutes.router;
